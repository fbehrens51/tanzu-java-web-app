...
```json
{
  ...
  "repositoryPrefix" : "623687983927.dkr.ecr.us-east-2.amazonaws.com/tws-tap-dev/tap-supply-chain"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->623687983927.dkr.ecr...(truncated)]
